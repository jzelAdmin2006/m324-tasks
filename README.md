...
```xml
<?xml version="1.0" ?>
<coverage version="7.6.8" timestamp="1732919085878" lines-valid="16" lines-covered="7" line-rate="0.4375" branches-covered="0" branches-valid="0" branch-rate="0" complexity="0">
   <!-- Generated by coverage.py: https://coverage.readthedocs.io/en/7.6.8 -->
   <!-- Based on https://raw.githubusercontent.com/cobertura/web/master/htdocs/xml/coverage-04.dtd -->
   <sources>
      <source>C:\workspace\m324-tasks\swtest\swtest</source>
   </sources>
   <packages>
      <package name="src" line-rate="0.1667" branch-rate="0" complexity="0">
         <classes>
            <class name="compare.py" filename="src/compare.py" complexity="0" line-rate="0.1667" branch-rate="0">
               <methods/>
               <lines>
      ...
      <package name="tests" line-rate="0.6" branch-rate="0" complexity="0">
         <classes>
            <class name="test.py" filename="tests/test.py" complexity="0" line-rate="0.6" branch-rate="0">
               <methods/>
               <lines>
                  <line number="1" hits="1"/>
